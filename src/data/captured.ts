...
const leaderImages: Record<string, string> = { repo: 'focus-github-06-branches', invite: 'focus-github-04-new-issue', issue: 'focus-github-04-new-issue', merge: 'desktop:web-02-merge-ready.png' };
